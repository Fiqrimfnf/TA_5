...
<div class="topnav" id="myTopnav">
    ...
    <a href="ManageUsers.php">tambah pengguna</a>
    <a href="UsersLog.php">Halaman Absensi</a>
    <a href="devices.php">Tambah Prodi</a>
    <?php  
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLongTitle">Update Akun anda:</h3>
